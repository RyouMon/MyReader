...
if git -C "$REPO_ROOT" ls-files \
  'my-reader-mobile/modules/myreader-rust-components/**/*.a' \
  'my-reader-mobile/modules/myreader-rust-components/**/*.so' \
  'my-reader-mobile/modules/myreader-rust-components/**/*.dylib' |
  grep -q .; then
