...
export const demoCommands = {
  ...
  createMyreaderLibrary: () => ok<LibraryInfo>(demoLibrary),
  createDefaultMyreaderLibrary: () => ok<LibraryInfo>(demoLibrary),
  openMyreaderLibrary: () => ok<LibraryInfo>(demoLibrary),
  createRemoteMyreaderLibrary: () => ok<LibraryInfo>(demoLibrary),
  openRemoteMyreaderLibrary: () => ok<LibraryInfo>(demoLibrary),
