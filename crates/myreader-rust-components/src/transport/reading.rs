...
pub(super) enum ReadingRequest {
    ...
    SetReadingPosition {
        ...
        #[cfg_attr(
            ...
            specta(type = myreader_core::models::typescript_contract::ReaderLocator)
        )]
    ...
    AddReaderAnnotation {
        ...
        #[cfg_attr(
            feature = "typescript-contract",
            specta(type = myreader_core::models::typescript_contract::ReaderAnnotationColor)
        )]
        color: String,
        note: Option<String>,
        recorded_at_ms: i64,
...
pub(super) enum ReadingResponse {
    ...
    SetFavoriteBook(()),
    GetReadingPosition(Option<myreader_core::models::ReadingPosition>),
    ListReadingPositions(Vec<myreader_core::models::ReadingPosition>),
    SetReadingPosition(()),
    ListReadingPositionCandidates(Vec<myreader_core::models::ReadingPositionCandidate>),
    SelectReadingPositionCandidate(()),
    ListReaderBookmarks(Vec<myreader_core::models::ReaderBookmark>),
    AddReaderBookmark(myreader_core::models::ReaderBookmark),
    RemoveReaderBookmark(()),
    ListReaderAnnotations(Vec<myreader_core::models::ReaderAnnotation>),
    AddReaderAnnotation(myreader_core::models::ReaderAnnotation),
    UpdateReaderAnnotation(myreader_core::models::ReaderAnnotation),
    RemoveReaderAnnotation(()),
    AddReadingSessionInterval(()),
    AddReadingCompletion(bool),
    GetReadingStatistics(myreader_core::models::ReadingStatistics),
}

pub(super) fn handle(request: ReadingRequest) -> Result<ReadingResponse, RustComponentsError> {
    Ok(match request {
        ReadingRequest::ListFavoriteBookIds { sidecar_root_path } => {
            ReadingResponse::ListFavoriteBookIds(run_core_async(
                myreader_core::api::reading::list_favorite_book_ids(Path::new(&sidecar_root_path)),
            )?)
        }
        ...
        ReadingRequest::GetReadingPosition {
            ...
            myreader_core::api::reading::get_reading_position(
                Path::new(&sidecar_root_path),
                book_id,
                &format,
            ),
        ...
        ReadingRequest::ListReadingPositions { sidecar_root_path } => {
            ReadingResponse::ListReadingPositions(run_core_async(
                myreader_core::api::reading::list_reading_positions(Path::new(&sidecar_root_path)),
            )?)
        }
        ...
        ReadingRequest::ListReaderBookmarks {
            ...
            myreader_core::api::reading::list_reader_bookmarks(
                Path::new(&sidecar_root_path),
                book_id,
                &format,
            ),
        ...
        ReadingRequest::AddReaderBookmark {
            ...
            myreader_core::api::reading::add_reader_bookmark(
                Path::new(&sidecar_root_path),
                Path::new(&library_root_path),
                book_id,
                &format,
        ...
        ReadingRequest::ListReaderAnnotations {
            ...
            myreader_core::api::reading::list_reader_annotations(
                Path::new(&sidecar_root_path),
                book_id,
                &format,
            ),
        ...
        ReadingRequest::AddReaderAnnotation {
            ...
            myreader_core::api::reading::add_reader_annotation(
                Path::new(&sidecar_root_path),
                Path::new(&library_root_path),
                book_id,
                &format,
        ...
        ReadingRequest::UpdateReaderAnnotation {
            ...
            myreader_core::api::reading::update_reader_annotation(
                Path::new(&sidecar_root_path),
                Path::new(&library_root_path),
                book_id,
                &format,
        ...
        ReadingRequest::AddReadingCompletion {
            ...
            myreader_core::api::reading::add_reading_completion(
                Path::new(&sidecar_root_path),
                Path::new(&library_root_path),
                &id,
                book_id,
        ...
        ReadingRequest::GetReadingStatistics {
            ...
            myreader_core::api::reading::get_reading_statistics(
                Path::new(&sidecar_root_path),
                Path::new(&library_root_path),
                &start_day,
                &end_day,
