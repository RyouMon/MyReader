...
export function resolveEffectiveFormat(readableFormats: string[], selectedFormat?: string): string | undefined {
...
export function pathBelongsToBook(relativePath: string, bookPath?: string): boolean {
