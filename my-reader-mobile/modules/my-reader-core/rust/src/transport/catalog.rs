...
pub(super) enum CatalogAsyncResponse {
    CountBooks(usize),
    ListBooks(Vec<my_reader_core::models::BookEntry>),
    ListBooksPage(my_reader_core::models::PaginatedBooks),
    ListBooksPageByLastRead(my_reader_core::models::PaginatedBooks),
    GetBookDetail(my_reader_core::models::BookDetail),
    ListSeriesBooks(Vec<my_reader_core::models::BookEntry>),
    GetLibraryUuid(String),
    ListBookSummaries(Vec<my_reader_core::models::BookSummary>),
    ListBookFormats(Vec<my_reader_core::models::BookFormat>),
}

pub(super) fn handle_sync(
    request: CatalogSyncRequest,
) -> Result<CatalogSyncResponse, CoreFfiError> {
    Ok(match request {
        CatalogSyncRequest::ValidateLibrary { library_root_path } => {
            CatalogSyncResponse::ValidateLibrary(my_reader_core::api::catalog::validate_library(
...
) -> Result<CatalogAsyncResponse, CoreFfiError> {
    Ok(match request {
        ...
        CatalogAsyncRequest::ListBooksPage {
            ...
            my_reader_core::api::catalog::list_books_page(
                Path::new(&library_root_path),
                offset,
                limit,
                sort_by.as_deref(),
        ...
        CatalogAsyncRequest::ListBooksPageByLastRead {
            ...
            my_reader_core::api::catalog::list_books_page_by_last_read(
                Path::new(&library_root_path),
        ...
        CatalogAsyncRequest::GetBookDetail {
            ...
            my_reader_core::api::catalog::get_book_detail(Path::new(&library_root_path), book_id),
        )?),
        CatalogAsyncRequest::ListSeriesBooks {
            ...
            my_reader_core::api::catalog::list_series_books(
                Path::new(&library_root_path),
                &series_name,
                exclude_book_id,
            ),
        ...
        CatalogAsyncRequest::ListBookFormats {
            ...
            my_reader_core::api::catalog::list_book_formats(Path::new(&library_root_path), book_id),
        )?),
    })
}
