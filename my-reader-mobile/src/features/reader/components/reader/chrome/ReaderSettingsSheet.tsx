  ...
  return (
    <>
      <SegmentPicker
        ...
        options={BACKGROUND_OPTIONS.map((o) => ({ key: o.key, label: t(o.labelKey) }))}
      ...
      {bundle.showPageDirection !== false ? (
        <SegmentPicker
          ...
          options={NAVIGATION_OPTIONS.map((o) => ({ key: o.key, label: t(o.labelKey) }))}
      ...
      <SegmentPicker
        ...
        options={PROGRESSION_OPTIONS.map((o) => ({ key: o.key, label: t(o.labelKey) }))}
      ...
      {Platform.OS === "ios" ? (
        <SegmentPicker
          ...
          options={SPREAD_OPTIONS.map((o) => ({ key: o.key, label: t(o.labelKey) }))}
          value={bundle.spread}
...
const ReaderSettingsSheet = forwardRef<BottomSheetModal, ReaderSettingsSheetProps>(
  function ReaderSettingsSheet({ palette, onDismiss, layout, reflow, fixed }, ref) {
    const { t } = useTranslation();
