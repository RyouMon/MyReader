// @ts-nocheck
// Generated by uniffi-bindgen-react-native. Do not edit manually.
import nativeModule, {
...
export const PatchAction = (() => {
  ...
  type Insert__interface = {
    ...
    inner: Readonly<{ obj: ObjId; index: /*u64*/ bigint; values: Array<Value> }>
  }
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        ...
        case 2:
          return new Position.Index({ position: FfiConverterUInt64.read(from) })
        default:
          throw new UniffiInternalError.UnexpectedEnumCase()
      }
    }
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        ...
        case 8:
          return new ScalarValue.Boolean({ value: FfiConverterBool.read(from) })
        case 9:
...
export interface DocInterface {
  ...
  changesSince(heads: Array<ChangeHash>): Array<Change>
  ...
  encodeChangesSince(heads: Array<ChangeHash>) /*throws*/: Array</*u8*/ number>
  ...
  mapEntriesAt(obj: ObjId, heads: Array<ChangeHash>) /*throws*/: Array<KeyValue>
  ...
  missingDeps(heads: Array<ChangeHash>): Array<ChangeHash>
...
export class Doc extends UniffiAbstractObject implements DocInterface {
  ...
  public changesSince(heads: Array<ChangeHash>): Array<Change> {
    return FfiConverterArrayTypeChange.lift(
      uniffiCaller.rustCall(
        /*caller:*/ (callStatus) => {
          return nativeModule().ubrn_uniffi_uniffi_automerge_fn_method_doc_changes_since(
            uniffiTypeDocObjectFactory.clonePointer(this),
  ...
  public missingDeps(heads: Array<ChangeHash>): Array<ChangeHash> {
    return FfiConverterArrayTypeChangeHash.lift(
      uniffiCaller.rustCall(
        /*caller:*/ (callStatus) => {
          return nativeModule().ubrn_uniffi_uniffi_automerge_fn_method_doc_missing_deps(
            uniffiTypeDocObjectFactory.clonePointer(this),
            FfiConverterArrayTypeChangeHash.lower(heads),
            callStatus,
          )
...
// FfiConverter for Array<Change>
const FfiConverterArrayTypeChange = new FfiConverterArray(
  FfiConverterTypeChange,
)
...
function uniffiEnsureInitialized() {
  ...
  if (
    nativeModule().ubrn_uniffi_uniffi_automerge_checksum_method_doc_changes_since() !==
    50297
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_uniffi_automerge_checksum_method_doc_changes_since",
    )
  }
  if (
  ...
  if (
    nativeModule().ubrn_uniffi_uniffi_automerge_checksum_method_doc_missing_deps() !==
    59523
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_uniffi_automerge_checksum_method_doc_missing_deps",
    )
  }
  if (
