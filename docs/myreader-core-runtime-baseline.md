...
- Android instrumentation APK 已从源码编译；连接设备后运行
  `:myreader-rust-components:connectedDebugAndroidTest` 完成 runtime 门禁。

具体命令见
[`my-reader-mobile/modules/myreader-rust-components/README.md`](../my-reader-mobile/modules/myreader-rust-components/README.md)。
