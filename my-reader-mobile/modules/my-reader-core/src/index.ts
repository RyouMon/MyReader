...
import installer from "./NativeMyReaderCore";
...
export * from "./generated/my_reader_core_ffi";

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as my_reader_core_ffi from "./generated/my_reader_core_ffi";
...
if (!initialized) {
  my_reader_core_ffi.default.initialize();
  initialized = true;
}
