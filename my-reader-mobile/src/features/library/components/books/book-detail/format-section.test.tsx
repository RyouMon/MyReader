...
function renderFormatSection(overrides: {
  ...
  return render(
    <FormatSection
      ...
      defaultFormat="EPUB"
      formatInfoMap={{
        EPUB: { relativePath: "Author/Test Book/Test Book.epub", localState: fileLocalState },
        PDF: { relativePath: "Author/Test Book/Test Book.pdf", localState: fileLocalState },
      }}
...
describe("FormatSection", () => {
  ...
  it("should show download action when format is remote and not present", () => {
    renderFormatSection({ fileLocalState: "remote_only", isNetworkSource: true });
